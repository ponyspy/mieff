$(function() {
	...
	$(document)
		...
		.on('click', '.item_rm.place', {path:'/admin/places/remove', description: 'Удалить площадку?'}, remove)
		.on('click', '.item_rm.program', {path:'/admin/programs/remove', description: 'Удалить программу?'}, remove)
